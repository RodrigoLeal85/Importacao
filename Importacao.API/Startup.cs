...
namespace Importacao.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ImportacaoBDContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ImportacaoBD")), ServiceLifetime.Transient);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Importacao.API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Importacao.API v1"));
            }
